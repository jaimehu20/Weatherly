...
export const WeatherPredictions : React.FC = () => {
    ...
    return <>
        ...
        <main className="mt-20 mb-20">
            <section className="bg-[url(https://besthqwallpapers.com/Uploads/16-2-2018/40884/4k-blue-sky-clouds-sun.jpg)] relative h-[150vh] w-full bg-cover bg-center flex justify-center">
