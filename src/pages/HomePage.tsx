...
export const Home : React.FC = () => {
    ...
    return <>
        ...
        <main>
            <Slogan />
            <div className={`${theme === "dark" ? "text-[#EDEDED]" : "text-[#26292B]"} flex flex-col w-[30%] max-1000:w-[90%] min-1000:w-[50%] min-1000:items-center font-[Poppins] mx-auto pb-[200px] max-1000:pb-[150px] max-1000:max-w-[514px]`}>
