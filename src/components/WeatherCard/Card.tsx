    ...
    return ( <>
            {props.current && props.location ? (
                ...
                <div className="flex flex-col items-center">
                    <h2 className="text-[35px] max-1000:text-[26px] min-1000:text-[30px]">{`${props.current.condition.text}`}</h2>
                    <img src={props.current.condition.icon} />
                    <h1 className="text-[40px] mt-[20px] font-black">{`${props.current.temp_c} °`}</h1>
                    <div className="flex gap-20 min-1000:gap-5 max-1000:gap-[10px] mt-[18px]">
                        <div className="flex flex-col">
                            <div className={`${theme === "dark" ? "bg-[rgb(81,99,108,0.6)]" : "bg-[rgb(255,255,255,0.6)]"} flex flex-col gap-3 mb-[38px] pl-[20px] pr-[20px] min-1000:pl-[10px] min-1000:pr-[10px] max-1000:pl-[10px] max-1000:pr-[10px] pt-[5px] pb-[5px] rounded-[12px] shadow-lg`}>
