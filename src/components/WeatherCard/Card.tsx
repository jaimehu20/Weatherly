...
export const Card  = (props : WeatherCardProps) => {
    ...
    return ( <>
            {props.current && props.location ? (
                <div className={`${theme === "dark" ? "bg-[rgb(81,99,108,0.6)] text-[#EDEDED]" : "bg-[rgb(223,233,245,0.6)] text-[#002E48]"} rounded-[12px] border border-[#091c47]-500 w-[80%] font-[Poppins] mb-[70px] cursor-pointer`}>
                ...
                <div className="flex flex-col items-center">
                    ...
                    <div className="flex gap-20 mt-[18px]">
                        <div className="flex flex-col">
                            <div className={`${theme === "dark" ? "bg-[rgb(81,99,108,0.6)]" : "bg-[rgb(255,255,255,0.6)]"} flex flex-col gap-3 mb-[38px] pl-[20px] pr-[20px] pt-[5px] pb-[5px] rounded-[12px] shadow-lg`}>
