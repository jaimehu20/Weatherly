...
export function BorderBeamDemo(props : BorderTitle) {
  ...
  return (
    <div className={`${theme === "dark" ? "bg-[#26292B]" : "bg-[#FFFFFF]"} relative flex w-[1000px] flex-col items-center justify-center overflow-hidden rounded-lg md:shadow-xl mx-auto mt-[60px] py-5 px-0`}>
