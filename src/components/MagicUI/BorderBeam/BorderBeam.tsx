...
export function BorderBeamDemo(props : BorderTitle) {
  return (
    <div className="relative flex w-[1000px] flex-col items-center justify-center overflow-hidden rounded-lg bg-background md:shadow-xl mx-auto mt-[60px] py-5 px-0">
